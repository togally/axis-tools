...
After a v0.2 capture command creates an outbox run, use `$axis-oss-publish` for dry-run or authorized synchronization. Project initialization itself is not publish completion.
