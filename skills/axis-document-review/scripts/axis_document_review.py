...
DEFAULT_TARGET = Path(os.environ.get("AXIS_DOCUMENT_REVIEW_DIR", "~/axis-document-review")).expanduser()
SKILL_ROOT = Path(__file__).resolve().parents[1]
TEMPLATE = SKILL_ROOT / "assets" / "axis-document-review-template.tgz"
