...
9. Report results in business terms:
   ...
   - slowest endpoint groups and endpoint-level slow rows sorted by response time, including method/path/query for code tracing;
...
- 慢接口明细：按 p95 响应时间降序列出 method/path/query、endpoint alias、group、p95、p99、avg、max、样本数、错误数
