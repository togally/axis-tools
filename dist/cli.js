...
async function projectInitCommand() {
    ...
    if (recover)
        throw new Error('--recover is not available until project-init apply support is enabled');
    if (apply)
        throw new Error('--apply is not available until project-init answers support is enabled');
...
async function buildInstallInventory(agent, force) {
...
async function installPackagedSkills(agent, force, dryRun) {
